...
const Landing = () => {
  ...
  return (
    <div className='w-full text-white overflow-hidden relative h-screen f2 bg-[#0f0f0f]'>
      ...
      <div className='absolute z-50 cursor-pointer bottom-8 f2 text-xl flex items-center justify-center left-[50%] w-44 h-12 shadow-lg border border-white rounded-full -translate-x-[50%]'>
