  ...
  return (
    ...
    <div className='sliders'>
      {/* this is for the sliding titles  */}
        ...
        <div className='title'><h1>Prism Sector</h1></div>
        <div className='title'><h1>Iron Eden Colony</h1></div>
        <div className='title'><h1>Neo Forge towers</h1></div>
        <div className='title'><h1>Arcadian complex</h1></div>
      ...
      {/* this is for the sliding images */}
        ...
        <div className='slide-images'>
          {/* this is the top portion of the images */}
          <div className="img_top"></div>

          {/* this is the bottom portion of the images */}
